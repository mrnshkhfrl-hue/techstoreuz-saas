      ...
      <div className="px-4 py-3 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          {process.env.NEXT_PUBLIC_STORE_LOGO && (
           ...
           <h1 className="text-xl font-black tracking-tighter text-gray-900 dark:text-white">{process.env.NEXT_PUBLIC_STORE_NAME || "Store"}<span className="text-[#2997FF]">.</span></h1>
        </div>
        ...
        <div className="flex items-center gap-1.5 ml-auto">
          ...
          {/* Cart Icon */}
          <button onClick={onCartClick} className="w-10 h-10 rounded-xl bg-gradient-to-r from-[#0A84FF] to-[#0071E3] flex items-center justify-center shadow-lg shadow-blue-500/25 border border-white/20 active:scale-95 transition-all text-white">
